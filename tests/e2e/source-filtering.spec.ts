...
test.describe('Source Filtering', () => {
  ...
  test.skip('filter state persists across page navigation', async ({
    page,
  }) => {
    ...
    const communityButtonAfterNav = page
      .locator('button:has-text("Community")')
      .first();
  ...
  test.skip('filter state persists in localStorage', async ({
    page,
    context,
  }) => {
    ...
    const newBuiltinButton = newPage
      .locator('button:has-text("Built-in")')
      .first();
